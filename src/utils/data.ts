...
const testimonies = [
  {
    ...
    star: 5,
    features: ["Pelayanan Bagus", "Harga Bagus", "Hasil Bagus", "Lancar Tanpa Masalah", "Anti Ribet, Tau Beres"],
    icon: testimoni1,
  ...
  },
  {
    title: "Sayuti",
    star: 5,
    features: ["Berkah Selalu", "Alhamdulillah Lancar", "Proses Cepat", "Biarkan Bintang Yang Jadi Saksi🥰"],
    icon: testimoni2,
  ...
  },
  {
    ...
    star: 5,
    features: ["Harga Murah", "Proses Cepat", "Terima Kasih, Lancar Selalu🥰"],
    icon: testimoni3,
  ...
  },
  {
    title: "Nalita Alvis",
    star: 5,
    features: ["Terima Kasih Banyak untuk Berkah Jasa", "Sangat Amanah Sekali", "Biarkan Bintangku Jadi Saksi"],
    icon: testimoni4,
  ...
  },
  {
    title: "Dwi Asmanto",
    star: 5,
    features: ["Proses Cepat", "Gak Pakai Ribet", "Lancar Terus Usahanya"],
    icon: testimoni5,
  ...
  },
  {
    ...
    star: 5,
    features: ["Harga Murah", "Proses Cepat", "Sukses Selalu Berkah Jasa"],
    icon: testimoni6,
...
const priorities = [
  ...
  },
  {
    ...
    pricelist: ["NIB seluruh Indonesia Rp1.000.000"],
  },
];
