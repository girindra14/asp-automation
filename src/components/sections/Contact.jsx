            ...
            <div className="container">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-6">
                        {/* Google Maps */}
                        <div className="bg-white p-4 rounded-lg border border-jmso-dark-blue/10 shadow-sm overflow-hidden">
                        ...
                        {/* Contact Information */}
                        <div className="bg-white p-6 rounded-lg border border-jmso-dark-blue/10 shadow-sm">
                            <h3 className="text-xl font-semibold text-jmso-dark-blue mb-4">
                                Contact Information
                            </h3>
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    />
                                    <div>
                                        <p className="font-medium text-jmso-dark-blue">
                                            Address
                                        </p>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="font-medium text-jmso-dark-blue">
                                            ...
                                            className="text-jmso-dark-blue/70 hover:text-jmso-tosca transition-colors"
                                        >
                                            {companyInfo.email}
                                        </a>
                                    </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="font-medium text-jmso-dark-blue mb-2">
                                            WhatsApp
                                        </p>
                                            ...
                                            className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md transition-all duration-300"
                                        >
